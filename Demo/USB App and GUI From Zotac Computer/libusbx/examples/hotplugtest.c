...
int main(int argc, char *argv[])
{
	...
	fprintf(stderr, "libusb_init() finished!\n");
	...
	fprintf(stderr, "libusb_has_capability() finished!\n");
	...
	fprintf(stderr, "libusb_hotplug_register_callback() finished!\n");
	...
	while (done < 2) {
		...
		fprintf(stderr, "main loop: done = %d, rc = %d\n", done, rc);
		if (rc < 0)
