...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        lineEdit->setGeometry(QRect(1000, 650, 21, 21));
        ...
        QBrush brush5(QColor(93, 179, 249, 255));
        ...
        QPalette palette3;
        QBrush brush6(QColor(81, 162, 0, 255));
        ...
        QPalette palette4;
        QBrush brush7(QColor(0, 103, 0, 255));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        lineEdit->setText(QApplication::translate("Widget", " M ", 0));
        lineEdit->setPlaceholderText(QApplication::translate("Widget", " M ", 0));
