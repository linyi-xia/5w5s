...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        label->setGeometry(QRect(370, 390, 511, 141));
        ...
        QPalette palette1;
        QBrush brush4(QColor(111, 10, 10, 255));
        ...
        label_2->setGeometry(QRect(310, 170, 591, 131));
        QPalette palette2;
        QBrush brush5(QColor(246, 250, 1, 255));
        ...
        label_3->setGeometry(QRect(350, 450, 561, 171));
        QPalette palette3;
